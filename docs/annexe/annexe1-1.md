...
sudo xcode-select --switch /Library/Developer/CommandLineTools # Activation de l'outil command line
```

Il suffit ensuite de relancer l'action de compilation de votre projer
